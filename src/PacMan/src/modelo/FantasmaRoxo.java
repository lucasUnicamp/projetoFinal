...
public final class FantasmaRoxo extends Fantasma{
    private transient BufferedImage fantasma, fugindo, olhos;

    public FantasmaRoxo(PainelJogo painel){
        super(painel);
        getImagem();
    }

    public FantasmaRoxo(PainelJogo painel, int x, int y, int velocidade, String direcao) {
    ...
    public void getImagem() {
        try {
            fantasma = ImageIO.read(new File(Paths.get("resources", "imagens", "fantasmaRoxo.png").toString()));
